# Chiang Mai AI Community — Meeting Archive
...
| Series | Day | Venue | Focus |
|--------|-----|-------|-------|
| AI Engineers | Saturday | The Kannas (prev. 4Seas, Morestto) | Technical deep-dives: developer tools, agent workflows, model comparisons, architecture patterns |
| AI Business | Wednesday | The Kannas (prev. Darkstar HQ) | Business strategy, market opportunities, AI-native sales, monetization |
| Agents in the Wild | Friday | The Kannas (prev. 4Seas) | Tracking the agentic AI movement: Open Claw, personal agents, agent-to-agent protocols |

There is also a sister community in Bangkok running similar events, but this repository covers the Chiang Mai sessions only.
...
This archive is maintained by community members. Anyone who attended a session can help improve it:

- **Fix errors** — correct tool names, speaker attributions, or technical details you remember differently
- **Add missing topics** — if something was discussed but not captured, add it
- **Link technologies** — add URLs to tools, repos, or papers that were mentioned
- **Identify speakers** — if you know who said what, attribute quotes to names
- **Add a missing session** — if you have a recording from a session we haven't covered, write an abridgment and submit it

If you have your own recording of a session, you can use any transcription service with diarization (we use Deepgram nova-3) to generate a transcript, then write or enrich the abridgment from it.
